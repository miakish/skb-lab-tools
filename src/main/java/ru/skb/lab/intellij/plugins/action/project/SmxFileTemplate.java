...
public class SmxFileTemplate extends JavaCreateTemplateInPackageAction<PsiClass> {
    ...
    public static final Icon ICON = IconLoader.getIcon("/META-INF/smx.svg", FileTemplatesFactory.class);
    ...
    protected final PsiClass doCreate(PsiDirectory dir, String className, String templateName) throws IncorrectOperationException {
        ...
        additionalProperties.put("JAVA_VERSION", "JAVA_17");
        additionalProperties.put("PROJECT_PACKAGE", "");
        additionalProperties.put("ACTIVEMQ_ENABLED", String.valueOf(false));
        ...
        additionalProperties.put("KAFKACOMPONENT_ENABLED", String.valueOf(true));
